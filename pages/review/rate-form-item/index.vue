  ...
  <list-cell :hover="false" last class="w-100 d-flex align-items-baseline">
    ...
    <view class="flex-fill d-flex flex-column">
      <view class="d-flex align-items-center mb-20">
        <view class="iconfont score" v-for="(item, index) in 5" :key="index" @tap="handleScoreClick(index)" :class="[value > index ? 'iconshoucangfill' : 'iconshoucang']" :style="{ opacity: value <= index || !value ? 1 : value / 5 + 0.1 }"> </view>
      </view>
