    ...
    setupPositionAdjustPattern: function () {
      for (var o = h.getPatternPosition(this.typeNumber), e = 0; e < o.length; e++)
        for (var r = 0; r < o.length; r++) {
          var t = o[e],
            i = o[r];
          if (null == this.modules[t][i]) for (var n = -2; n <= 2; n++) for (var a = -2; a <= 2; a++) this.modules[t + n][i + a] = -2 == n || 2 == n || -2 == a || 2 == a || (0 == n && 0 == a);
        }
    },
    ...
    h = {
      ...
      getLostPoint: function (o) {
        for (var e = o.getModuleCount(), r = 0, t = 0; t < e; t++)
          for (var i = 0; i < e; i++) {
            for (var n = 0, a = o.isDark(t, i), d = -1; d <= 1; d++) if (!(t + d < 0 || e <= t + d)) for (var u = -1; u <= 1; u++) i + u < 0 || e <= i + u || (0 == d && 0 == u) || (a == o.isDark(t + d, i + u) && n++);
            n > 5 && (r += 3 + n - 5);
          }
        for (t = 0; t < e - 1; t++)
          for (i = 0; i < e - 1; i++) {
        ...
        for (t = 0; t < e; t++) for (i = 0; i < e - 6; i++) o.isDark(t, i) && !o.isDark(t, i + 1) && o.isDark(t, i + 2) && o.isDark(t, i + 3) && o.isDark(t, i + 4) && !o.isDark(t, i + 5) && o.isDark(t, i + 6) && (r += 40);
        for (i = 0; i < e; i++) for (t = 0; t < e - 6; t++) o.isDark(t, i) && !o.isDark(t + 1, i) && o.isDark(t + 2, i) && o.isDark(t + 3, i) && o.isDark(t + 4, i) && !o.isDark(t + 5, i) && o.isDark(t + 6, i) && (r += 40);
        var g = 0;
...
(f.prototype = {
  ...
  multiply: function (o) {
    for (var e = new Array(this.getLength() + o.getLength() - 1), r = 0; r < this.getLength(); r++) for (var t = 0; t < o.getLength(); t++) e[r + t] ^= c.gexp(c.glog(this.get(r)) + c.glog(o.get(t)));
    return new f(e, 0);
  },
  mod: function (o) {
  ...
  (b.prototype.make = function () {
    ...
    s.addData(
          ...
          for (var f = 0; f < u; f++) {
            ...
            if (d[m][f]) {
              var C = c,
                ...
                y = h,
                w = h;
              d[m][f] = { type: ['foreground'], color: n, isBlack: !0, isDrawn: !1, destX: v, destY: p, destWidth: s, destHeight: s, x: b, y: k, width: y, height: w, paddingTop: C, paddingRight: C, paddingBottom: C, paddingLeft: C };
            } else
              (C = l),
                (b = v + l),
                (k = p + l),
                (y = g),
                (w = g),
                (d[m][f] = { type: ['background'], color: t, isBlack: !1, isDrawn: !1, destX: v, destY: p, destWidth: s, destHeight: s, x: b, y: k, width: y, height: w, paddingTop: C, paddingRight: C, paddingBottom: C, paddingLeft: C });
          }
      })(this),
      (function (o) {
      ...
      (function (o) {
        let { typeNumber: e, modules: r, moduleCount: t, foregroundColor: i, backgroundColor: n, positionAdjustForegroundColor: a, positionAdjustBackgroundColor: d, timingForegroundColor: u, timingBackgroundColor: s } = o;
        const g = [
          [],
          [6, 18],
          [6, 22],
  ...
  (b.prototype.getDrawModules = function () {
    ...
    i && o.push({ name: 'area', type: 'area', color: i, x: 0, y: 0, width: t, height: t }),
      n && o.push({ name: 'backgroundImage', type: 'image', imageSrc: n, mappingName: 'backgroundImageSrc', x: a, y: d, width: u, height: s, alpha: g, borderRadius: l });
    for (var B = 0; B < r; B++)
      for (var S = 0; S < r; S++) {
        var P = e[B][S];
        P.isDrawn ||
  ...
  (b.prototype.drawCanvas = function () {
    let { isMaked: o, canvasContext: e, useDynamicSize: r, dynamicSize: t, foregroundColor: i, foregroundPadding: n, backgroundColor: a, backgroundPadding: d, drawReserve: u, margin: s } = this;
              ...
              case 'image':
                if ('backgroundImage' === n.name) {
                  ...
                  p < 2 * k && (k = p / 2),
                    ...
                    k > 0
                      ? (e.beginPath(), e.moveTo(f + k, v), e.arcTo(f + p, v, f + p, v + C, k), e.arcTo(f + p, v + C, f, v + C, k), e.arcTo(f, v + C, f, v, k), e.arcTo(f, v, f + p, v, k), e.closePath(), e.setFillStyle(n.backgroundColor), e.fill())
